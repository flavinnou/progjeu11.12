...
drawText('Arrows to move and space to shoot!', font, windowSurface, (WINDOWWIDTH / 4) - 50, (WINDOWHEIGHT / 3) + 200)
drawText('Press a key to start.', font, windowSurface, (WINDOWWIDTH / 2.5) - 50, (WINDOWHEIGHT / 2) + 200)
...
def show_gameover_screen():
    ...
    drawText("Your Score was %s" % (score), font, windowSurface, WINDOWWIDTH /3, WINDOWHEIGHT /3)
    drawText("Your Top Score is %s" % (topScore), font, windowSurface, WINDOWWIDTH / 5, WINDOWHEIGHT / 5)
    drawText("Press a key to try again", font, windowSurface, WINDOWWIDTH / 4, WINDOWHEIGHT / 4)
